            ...
            <div className="rounded-4xl border surface-card bg-white/94 p-8 card-shadow sm:p-10">
              ...
              <div className="mt-8 grid gap-4 md:grid-cols-2">
                <div className="rounded-3xl border border-border/70 bg-background/88 p-5">
                  ...
                  <p className="mt-2 text-sm text-contrast-muted">{session.user.email}</p>
                </div>
                <div className="rounded-3xl border border-border/70 bg-background/88 p-5">
                ...
                <div className="rounded-3xl border border-border/70 bg-background/88 p-5">
                  ...
                  <p className="mt-2 text-sm text-contrast-muted">{profile?.phone || "Add later"}</p>
                </div>
                <div className="rounded-3xl border border-border/70 bg-background/88 p-5">
            ...
            <div className="rounded-4xl border surface-card bg-white/94 p-8 card-shadow sm:p-10">
              ...
              <div className="mt-5 grid gap-4">
                <div className="rounded-3xl border border-border/70 bg-background/88 p-5">
                  ...
                  <p className="mt-2 text-sm leading-7 text-contrast-muted">Paid orders will appear here as they are created through the live checkout flow.</p>
                </div>
                <div className="rounded-3xl border border-border/70 bg-background/88 p-5">
                  <p className="text-sm font-semibold text-foreground">Saved addresses</p>
                  <p className="mt-2 text-sm leading-7 text-contrast-muted">Saved addresses will be managed here once customer address entry is enabled in the app.</p>
                </div>
                <div className="rounded-3xl border border-border/70 bg-background/88 p-5">
                  <p className="text-sm font-semibold text-foreground">Checkout status</p>
                  <p className="mt-2 text-sm leading-7 text-contrast-muted">Checkout status and payment updates will be reflected here as orders move through the live flow.</p>
                </div>
              </div>
            </div>
          </div>
